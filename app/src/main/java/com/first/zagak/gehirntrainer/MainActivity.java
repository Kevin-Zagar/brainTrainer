...
public class MainActivity extends AppCompatActivity{
    ...
    -answerRandomMathQuestion Method: It answers the random math question.
    ...
    public void startButton(android.view.View v){
        ...
        calculation.answerRandomMathQuestion();

        // Buttons are getting a random answer thats near the right answer
        calculation.noMoreThanOneSameAnswer();
    ...
    public void button1(android.view.View v){
        ...
        Log.i("Tag", buttons.getTag().toString());
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        calculation.button1 = findViewById(R.id.button1);
        calculation.button2 = findViewById(R.id.button2);
        calculation.button3 = findViewById(R.id.button3);
        calculation.button4 = findViewById(R.id.button4);
